  ...
  return (
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <>
          {/* Stats — clickeables: llevan a Paquetes filtrado por ese estado */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {counts.map(c => (
              <a key={c.key} href={`/tienda/paquetes?estado=${c.key}`}
                className={`card ${c.bg} hover:shadow-md hover:-translate-y-0.5 transition-all`}>
